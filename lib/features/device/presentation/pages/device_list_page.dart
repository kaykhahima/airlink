...
class DeviceListPage extends StatelessWidget {
                      ...
                      return RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return BLEDeviceTile(model: bleDevice, onTap: () {
                              _navigateToDetailsPage(context: context, model: bleDevice);
                            });
                          },
                        ),
                      );
  ...
  void _navigateToDetailsPage({required BuildContext context, required DeviceModel model}) async {
    Navigator.push(
      context,
      MaterialPageRoute(
